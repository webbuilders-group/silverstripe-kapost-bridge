    ...
    public function ConvertObjectForm() {
        ...
        $fields=new FieldList(
                            $wrapper=CompositeField::create(
                                    CompositeField::create(
                                        ...
                                        )->addExtraClass('kapostConvertLeftSide noborder')->setName('kapostConvertLeftSide'),
                                    CompositeField::create(
        ...
        if($convertToClass!==false && ($convertToClass=='SiteTree' || is_subclass_of($convertToClass, 'SiteTree'))) {
            ...
            if(!empty($obj) && $obj!==false && $obj->ID>0) {
                $form->Fields()->insertBefore('kapostConvertTypeWrap', HiddenField::create('ConvertMode', 'ConvertMode', 'ReplacePage')->setForm($form));
                $form->Fields()->insertBefore('kapostConvertTypeWrap', HiddenField::create('ReplacePageID', 'ReplacePageID', $obj->ID)->setForm($form));
